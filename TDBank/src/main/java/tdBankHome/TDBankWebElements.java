...
public class TDBankWebElements {
    ...
    public static final String homePageTDBankLogo = "//div[@class='td-section-left']//a//img";
    public static final String homePageSmallBusinessTab = "//div[@class='td-segments']//a[contains(text(),'Small Business')]";
    public static final String homePageSmallBusinessHeadlinesText = "//p[@class='td-banner-headline']";
