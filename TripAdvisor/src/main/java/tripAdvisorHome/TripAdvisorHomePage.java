...
//        String actualResult = getTextByXpath(tripAdvisorGageHotelCheckText);
    ...
    @FindBy(how = How.XPATH, using = trpAdvCalanderDate)
    public WebElement calanderDate;

    String dateValue = "Sep 30,2020";
    String returnDate = "03/25/2021";
    public void tripAdvisorGageHotelCheckIn() throws InterruptedException {
        tripAdvisorGageHotelCheck();
        driver.navigate().to("https://www.tripadvisor.com/Hotel_Review-g56228-d122807-Reviews-Gage_Hotel-Marathon_Texas.html");
        selectDateByJS(driver, calanderDate, dateValue);
        Thread.sleep(3000);
    }
    //        driver.findElement(By.xpath(trpAdvGageHotelText)).isDisplayed();
