...
public class HomeFunctionPage extends WebAPI {
    ...
    public void cartSignIn() throws InterruptedException {
        ...
        userPassword.sendKeys("pnt30247");
        Thread.sleep(3000);
        userSign.click();
    }
    ...
    public void signInButton() throws InterruptedException {
        ...
        createAcc.click();
        Thread.sleep(2000);
        emailAdd.sendKeys("pnt30247_NY@gmail.com");
        useFirstName.sendKeys("Ehsan");
        useLastName.sendKeys("Kabir");
        useMobile.sendKeys("7180000000");
        usePassword.sendKeys("pnt30247");
    ...
    public void useLogIn() throws InterruptedException {
        ...
        useLogIn.click();
        Thread.sleep(2000);
        userName.sendKeys("pnt30247_NY@gmail.com");
        userPassword.sendKeys("pnt30247");
        Thread.sleep(3000);
        useSignIn.click();
    }
